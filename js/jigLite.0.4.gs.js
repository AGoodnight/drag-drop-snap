	...
	var library = {
		...
		hop:{
			...
			animation:function(actor,o,d){
				...
				var s=[o._speed/5,o._speed/3,o._speed/4];
				var f = 0;
				for(var i in s){ f += s[i]; };
				s[3] = o._speed%f;

						
				var amp = o._offsetY+( (o._amplitude*-1)*o._self.data._height );
...
function getStyle(element, prop, keepUnits){
...
function computedStyle(elm, style) {
    var computedStyle;
